...
#include "abr_synth_vm_ilist_op.h"
#include "abr_synth_vm_imeta_op.h"
...
#include "abr_synth_vm_plist_op.h"
...
#include "abr_synth_vm_pstep_op.h"
...
void abr_synth_init(abr_context_t* ctx)
{
    ...
    abr_synth_vm_ilist_op_register(ctx);
    abr_synth_vm_imeta_op_register(ctx);
    ...
    abr_synth_vm_plist_op_register(ctx);
    ...
    abr_synth_vm_pstep_op_register(ctx);
